...
namespace WpfApp3.Model
{
    ...
    public class Customermain_Model : ModelBase, IEditableObject
    {
        private string _customerId = null!;
        private string? _description;
        private string? _customerLabelCode;
        ...
        public string? CustomerLabelCode
        {
            get { return this._customerLabelCode; }

            set
            {
                this._customerLabelCode = value;
                this.RaisePropertyChanged(nameof(this.CustomerLabelCode));
            }
        }
